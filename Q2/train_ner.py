...
#bilstm+glove/random+layernorm+char+crf
    ...
    os.system('python3 Train2_2__bilstm_crf_layernorm_char_random_glove.py --initialization {} --output_file {} --data_dir {} --glove_embeddings_file {} --vocabulary_output_file {}'.format(args.initialization, args.output_file, args.data_dir, args.glove_embeddings_file, args.vocabulary_output_file ))
