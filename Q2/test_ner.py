...
if(args.char_embeddings == 0 and args.layer_normalization == 0 and args.crf == 0):
    os.system('python3 TEST2_1_1_bilstm_random_glove.py --model_file {} --output_file {} --test_data_file {} --glove_embeddings_file {} --vocabulary_input_file {}'.format(args.model_file, args.output_file, args.test_data_file, args.glove_embeddings_file, args.vocabulary_input_file ))

#bilstm+char+glove/random
elif(args.char_embeddings == 1 and args.layer_normalization == 0 and args.crf == 0):
    os.system('python3 TEST2_1_3_bilstm_char_random_glove.py --model_file {} --output_file {} --test_data_file {} --glove_embeddings_file {} --vocabulary_input_file {}'.format(args.model_file, args.output_file, args.test_data_file, args.glove_embeddings_file, args.vocabulary_input_file ))
